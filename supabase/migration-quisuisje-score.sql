-- =====================================================================
--  Ajoute « Qui suis-je ? » (quisuisje) aux classements des jeux.
...
alter table public.arcade_scores
  ...
  check (game in ('quiz','vraifaux','memoriser','quisuisje'));
...
begin
  ...
  if p_game not in ('quiz','vraifaux','memoriser','quisuisje') then return; end if;
