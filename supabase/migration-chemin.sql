-- =====================================================================
--  Ajoute « Le Chemin » (chemin) aux classements des jeux.
...
alter table public.arcade_scores
  ...
  check (game in ('quiz','vraifaux','memoriser','quisuisje','chrono','fronde','chemin'));
...
begin
  ...
  if p_game not in ('quiz','vraifaux','memoriser','quisuisje','chrono','fronde','chemin') then return; end if;
