...
export function BottomNav() {
  ...
  return (
    <>
      ...
      {moreOpen ? (
        <>
          <button
            ...
            className="fixed inset-0 z-[70] bg-night-950/60 backdrop-blur-sm"
          />
          <div className="fixed inset-x-0 bottom-0 z-[71] rounded-t-3xl border-t border-white/10 bg-night-900 p-5 pb-[calc(1.25rem+env(safe-area-inset-bottom))] text-cream">
            ...
            <div className="grid grid-cols-3 gap-3">
              {MORE.map((m) => (
                ...
                >
                  <span className="grid h-10 w-10 place-items-center rounded-xl bg-dawn-400/15 text-dawn-300">
      ...
      {/* Barre d'onglets */}
      <nav className="fixed inset-x-0 bottom-0 z-[60] border-t border-white/10 bg-night-950/95 pb-[env(safe-area-inset-bottom)] backdrop-blur-xl">
        <div className="mx-auto flex max-w-lg items-stretch justify-around">
            ...
            return (
              <Link
                ...
                className={`flex flex-1 flex-col items-center gap-1 py-2.5 text-[10px] font-semibold transition-colors ${
                  active ? "text-dawn-400" : "text-cream/55"
                }`}
              >
          ...
          <button
            ...
            className={`flex flex-1 flex-col items-center gap-1 py-2.5 text-[10px] font-semibold transition-colors ${
              moreOpen ? "text-dawn-400" : "text-cream/55"
            }`}
          >
