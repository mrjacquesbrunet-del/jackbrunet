...
export function BottomNav() {
  ...
  return (
    <nav className="bottom-nav fixed inset-x-0 bottom-0 z-[60] border-t border-white/10 bg-[#131312]/95 pb-[env(safe-area-inset-bottom)] backdrop-blur-xl">
      <div className="relative mx-auto max-w-lg">
        ...
        <div
          className={`pointer-events-none absolute inset-y-0 right-0 flex w-8 items-center justify-end bg-gradient-to-l from-[#131312] to-transparent pr-1 text-cream/40 transition-opacity duration-300 ${
