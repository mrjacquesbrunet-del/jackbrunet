...
/**
 * Petit bouton rond flottant (bas-droite, au-dessus de la barre d'onglets):
 * - pendant la lecture (Bible, plans…): raccourci vers « Mon carnet » ;
 * - dans le carnet / les favoris: retour direct à la Bible.
 * Les gens y vont souvent, donc il reste toujours accessible d'un pouce.
 */
