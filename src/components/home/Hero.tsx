...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        style={{ y: yBlob }}
        className="blob left-1/4 top-10 h-[28rem] w-[28rem] bg-spirit-600/30 animate-pulse-glow"
      />
      <motion.div
        style={{ y: yBlob }}
        className="blob right-1/4 top-1/3 h-96 w-96 bg-dawn-500/25 animate-pulse-glow"
      />
      <div className="absolute left-1/2 top-1/2 h-[36rem] w-[36rem] -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/5 animate-spin-slow" />
      ...
      >
          ...
          >
            <div className="flex -space-x-2.5">
              {[
                ...
                <span
                  key={i}
                  className={`h-9 w-9 rounded-full border-2 border-night-950 bg-gradient-to-br ${g}`}
                />
              ))}
            </div>
            <p>
              <span className="font-semibold text-cream">+120 000</span> personnes
        ...
        >
          <div className="glass-strong relative overflow-hidden rounded-4xl p-7 shadow-card animate-float">
