...
: "Voir l'agenda";
  ...
  return (
    // `site-only` : ce bandeau appartient au SITE (agenda du pasteur) ;
    // l'application RHEMA, marque neutre, le masque (cf. globals.css).
    <section className="site-only container-x pt-4">
