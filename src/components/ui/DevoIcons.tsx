...
export const HandsGlyph = ({ className }: P) => (
  <Svg className={className}>
    <path d="M12 3.4c-.6 1.1-1.3 2-2.4 3.1L6.3 9.8c-.6.6-.9 1.5-.7 2.3l.8 4A1.8 1.8 0 0 0 8.2 19.5H12Z" />
    <path d="M12 3.4c.6 1.1 1.3 2 2.4 3.1L17.7 9.8c.6.6.9 1.5.7 2.3l-.8 4A1.8 1.8 0 0 1 15.8 19.5H12Z" />
    <path d="M9.4 12.1c1.7-.9 3.5-.9 5.2 0" />
  </Svg>
);
