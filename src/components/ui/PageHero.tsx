...
export function PageHero({ eyebrow, title, description, children }: PageHeroProps) {
  return (
    <section className="relative overflow-hidden pt-32 sm:pt-40">
      ...
      <div className="blob left-1/3 top-10 h-80 w-80 bg-spirit-600/25 animate-pulse-glow" />
      <div className="blob right-1/4 top-1/2 h-72 w-72 bg-dawn-500/20 animate-pulse-glow" />
