...
export function PrayerCirclesCard() {
  return (
    <div className="mt-4 grid grid-cols-2 gap-2">
      <Link
        href="/groupes"
        className="dark-ctx flex flex-col items-center gap-1.5 rounded-2xl bg-night-900 px-3 py-4 text-center text-cream transition-transform active:scale-[0.98]"
      >
