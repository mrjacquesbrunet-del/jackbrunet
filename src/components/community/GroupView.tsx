  ...
  return (
    <section className="relative pb-28 text-cream" style={{ background: BG, minHeight: "100vh" }}>
      ...
      <div
        ...
        style={{ background: "linear-gradient(160deg, #131312, #2A2A29)" }}
      >
        {group.image ? (
          <>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            ...
            <div
              ...
              style={{ backgroundImage: "linear-gradient(160deg, rgba(19, 19, 18,0.86), rgba(38,48,26,0.92))" }}
            />
          </>
        ) : null}
    ...
    open && mounted
      ? createPortal(
          ...
          >
            ...
            <div className="relative z-10 max-h-full w-full max-w-sm overflow-y-auto rounded-2xl border border-white/10 bg-[#1C1C1B] p-4 text-cream shadow-xl">
                  ...
                  <div className="mt-2 flex flex-wrap gap-2">
                    {(Object.keys(ACCENTS) as AccentKey[]).map((k) => (
                      <button
                        ...
                        className={`h-8 w-8 rounded-full ring-2 ring-offset-2 ring-offset-[#1C1C1B] ${f.accent === k ? "ring-cream" : "ring-transparent"}`}
