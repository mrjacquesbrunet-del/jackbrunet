...
export const BADGE_HOW_TO: Record<BadgeKind, string> = {
  ...
  etoile: "Monte dans les ligues : finis en haut du tableau de ta division le dimanche soir. Bronze du badge en atteignant la ligue Argent, argent en ligue Or, or en ligue Élite.",
